...
internal enum PrepareStatement {
...
//===============================================================================================
    //Prepare Functions
//===============================================================================================
    fileprivate func prepareV1(dbPointer: OpaquePointer, sql: String) throws -> OpaquePointer? {
    ...
    fileprivate func prepareV2(dbPointer: OpaquePointer, sql: String) throws -> OpaquePointer? {
        var statement: OpaquePointer?
    ...
    fileprivate func prepare16V1(dbPointer: OpaquePointer, sql: String) throws -> OpaquePointer? {
        var statement: OpaquePointer?
    ...
    fileprivate func prepare16V2(dbPointer: OpaquePointer, sql: String) throws -> OpaquePointer? {
        var statement: OpaquePointer?
...
//===============================================================================================
    internal func prepareStatement(sqlStatement: String, statementType: PrepareStatement) throws -> OpaquePointer? {
